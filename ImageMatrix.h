...
public:
    ...
    int get_height() const; // Get the height of the image
    int get_width() const; // Get the width of the image
    void set_data(int i, int j, double value); // Set the data at the given index
    void clip_pixel_values(double min_value, double max_value);
